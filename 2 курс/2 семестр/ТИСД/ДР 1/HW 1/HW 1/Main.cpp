...
int main()
{
	Real::Real a1{ "3.4" };
	Real::Real b1{ "1.2" };
	std::cout << a1.ToString() << " / " << b1.ToString() << " = " << a1.Divide(b1)->ToString() << "\n";

	Real::Real a2{ "-3.4" };
	Real::Real b2{ "1.23" };
	std::cout << a2.ToString() << " / " << b2.ToString() << " = " << a2.Divide(b2)->ToString() << "\n";

	Real::Real a3{ "12.3" };
	Real::Real b3{ "-1.2" };
	std::cout << a3.ToString() << " / " << b3.ToString() << " = " << a3.Divide(b3)->ToString() << "\n";

	Real::Real a4{ "-1.2" };
	Real::Real b4{ "-3.45" };
	std::cout << a4.ToString() << " / " << b4.ToString() << " = " << a4.Divide(b4)->ToString() << "\n";

	Real::Real a5{ "1.28" };
	Real::Real b5{ "3.2" };
	std::cout << a5.ToString() << " / " << b5.ToString() << " = " << a5.Divide(b5)->ToString() << "\n";

	Real::Real a6{ "1.2832" };
	Real::Real b6{ "3.2" };
	std::cout << a6.ToString() << " / " << b6.ToString() << " = " << a6.Divide(b6)->ToString() << "\n";
